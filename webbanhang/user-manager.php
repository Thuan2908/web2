    ...
    <div class="modal-user">
        <form class="modal-user__container" action="user-manager.php?enableQuery" method="POST" autocomplete="off">
            ...
            <div class="modal-user-container__content">
                ...
                <label for="modal-user-container-content-houseAndRoadAddress">Địa chỉ *</label>
                ...
                <button type="submit" class="modal-user-container-content__btn insert" name="submit" value="insert" onclick="return checkUserForm('thêm');" style="display: none;">Thêm</button>
                <button type="submit" class="modal-user-container-content__btn edit" name="submit" value="edit" onclick="return checkUserForm('sửa');" style="display: none;">Sửa</button>
            </div>
        </form>
    </div>
