      ...
      <div id="content-user">
        ...
        while ($row = mysqli_fetch_array($result)) {
          ...
          if ($orderStatus != "S04" && $orderStatus != "S03" && $orderStatus != "S05") {
            ...
            // echo '<label style="display:flex;flex-direction: row;margin-left: 20px;" class="hoverTheA22">Nhấn nút bên cạnh để hủy đơn hàng -></label> <input id="myInput" name="valueID" type="submit" 
            // value="' . $orderID . '" onclick="myFunction();" style="margin-left:4px;width:fit-content;display:block;text-align: right;">';


            echo '<label style="display:flex;flex-direction: row;margin-left: 20px;" class="hoverTheA22">
        Nhấn nút bên cạnh để hủy đơn hàng ->
      </label> 
      <input type="hidden" name="valueID" value="' . $orderID . '">
      <input id="myInput" type="submit" 
             value="HỦY" 
             onclick="myFunction();" 
             style="margin-left:4px;width:fit-content;display:block;text-align: right; padding: 0px 5px 0px 5px">';
