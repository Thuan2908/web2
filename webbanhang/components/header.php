...
<div id="menu-header">
    ...
    <p class="child-menu-header" style="width: auto;order: 5;"><a id="navbarAbout" class="navbartheA" href="about_us.php">Giới thiệu</a></p>
...
if (isAdminLogged()) {
    echo ' 
    <p style="order: 4;color:#fff;"> ';echo $_SESSION['current_fullName'];
    echo '</p>
