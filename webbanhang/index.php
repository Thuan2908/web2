...
<body>
  ...
  <div id="main"
    ...
    <!-- <div id="ỉntroduction" style="display: flex;    background-color: r#fff;
    ...
    <div style="background-color: #fff;">
      <p class="bigtitlehome" style="text-align:center ;">CÁC THƯƠNG HIỆU ĐỒNG HỒ ĐANG PHỔ BIẾN HIỆN NAY</p>
      <div id="productKD" style="margin-top: 30px;margin-left: 50px;margin-right: 50px;">
        <div
          style="width: 200px;height:200px;background-color:rgba(206, 60, 60);display: flex;justify-content: center;align-items: center;">
        ...
        <div
          style="width: 200px;height:2020x;background-color:rgba(206, 60, 60);display: flex;justify-content: center;align-items: center;">
    ...
    <div id="casioBrandInfo" style="background-color: #fff; margin-top: 56px; padding-bottom: 56px;">
